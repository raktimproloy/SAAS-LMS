  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-8 pb-10 w-full max-w-[1920px] mx-auto">
        ...
        <div className="relative bg-card/40 backdrop-blur-3xl p-8 md:p-10 rounded-[2.5rem] shadow-2xl flex flex-col justify-center items-start border border-white/10 mb-2 w-full h-[220px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="bg-card border-border rounded-xl overflow-hidden border shadow-sm p-6 flex flex-col h-[240px]">
                <Skeleton className="w-12 h-12 rounded-2xl bg-white/10 mb-5 shrink-0" />
                <Skeleton className="h-6 w-3/4 bg-white/10 rounded-md mb-2" />
                ...
                <div className="flex gap-3">
                  ...
                  <Skeleton className="h-10 w-12 bg-white/10 rounded-md shrink-0" />
                </div>
              </div>
            ))}
          </div>
