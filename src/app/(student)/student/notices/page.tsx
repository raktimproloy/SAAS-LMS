      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
        {notices.length === 0 ? (
          ...
          notices.map((notice, index) => (
            <Card key={notice.id} data-aos="fade-up" data-aos-delay={(index % 5) * 100} className="hover:shadow-xl transition-all duration-300 group overflow-hidden flex flex-col h-full bg-card/90 dark:bg-card/40 backdrop-blur-md border border-border rounded-3xl hover:-translate-y-1">
