      ...
      <div className="bg-card/80 backdrop-blur-xl border-b border-border shadow-sm dark:shadow-none">
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-2">
            <Skeleton className="h-7 w-64 md:w-96 bg-white/10 rounded-md" />
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-card/90 backdrop-blur-xl border-t border-border shadow-sm p-3 sm:p-4 z-50">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-6">
            <Skeleton className="h-10 sm:h-12 w-24 sm:w-32 bg-white/10 rounded-lg" />
          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            <Skeleton className="h-8 w-12 bg-white/10 rounded-lg sm:hidden" />
            <Skeleton className="h-10 sm:h-11 w-28 sm:w-36 bg-white/10 rounded-xl" />
          </div>
        </div>
      </div>
    </div>
