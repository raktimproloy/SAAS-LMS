...
export function FeaturesSection() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#0B0F19] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-6 tracking-tight">
            সেরা শিক্ষার <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">অভিজ্ঞতা</span>
          </h2>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative rounded-[2rem] bg-white/5 border border-white/10 p-8 sm:p-10 overflow-hidden hover:-translate-y-2 transition-all duration-500 ${feature.borderColor}`}
              >
                {/* Background Hover Gradient */}
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500 shadow-xl backdrop-blur-sm">
