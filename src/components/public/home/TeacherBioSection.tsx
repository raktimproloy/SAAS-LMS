...
import { Play, Award, BookOpen, HeartPulse } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div data-aos="fade-left" className="relative">
            ...
            <div className="relative rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl aspect-[16/10] sm:aspect-video group cursor-pointer bg-black/50 backdrop-blur-sm">
              {/* Thumbnail Image */}
              <div 
              ...
              {/* Video Info Overlay */}
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 bg-gradient-to-t from-black/90 via-black/50 to-transparent transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
